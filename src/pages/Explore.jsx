...
import waterride from "../assets/images/waterride.png";
import waterride1 from "../assets/images/waterride1.png";
import waterride2 from "../assets/images/waterride2.png";
...
const Explore = () => {
  ...
  const [rides, setrides] = useState([
    [ride1, ride2, ride3],
    [waterride, waterride1, waterride2],
      ...
      <div style={{ display: modelvis, scale: 0 }} className="model fixed flex items-center justify-center top-10 backdrop-blur-sm left-0 h-full w-full  z-89 "
        ...
        <div className="box px-3  h-[80vh] w-[70%] bg-[#77B7FA] rounded-2xl " onClick={(e) => { console.log('clicked bbox'); e.stopPropagation(); finalflag = false }}>
          ...
          <div
            ...
            <img src={cardidx != undefined && park[cardidx] ? (park[cardidx].category == 'Adventure Park' ? rides[0][0] : park[cardidx].category == 'Water Park' ? rides[1][0] : rides[2][0]) : undefined} className='mb-3 rounded-2xl h-[350px] w-[85%] border-2' alt="" />
            <img src={cardidx != undefined && park[cardidx] ? (park[cardidx].category == 'Adventure Park' ? rides[0][1] : park[cardidx].category == 'Water Park' ? rides[1][1] : rides[2][1]) : undefined} className='mb-3 rounded-2xl h-[350px] w-[85%] border-2' alt="" />
            <img src={cardidx != undefined && park[cardidx] ? (park[cardidx].category == 'Adventure Park' ? rides[0][2] : park[cardidx].category == 'Water Park' ? rides[1][2] : rides[2][2]) : undefined} className='mb-3 rounded-2xl h-[350px] w-[85%] border-2' alt="" />
